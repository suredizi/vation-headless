...
MapTo('vation-headless/components/separator')(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn});

MapTo('vation-headless/components/button')(ButtonV1, {isEmpty: ButtonV1IsEmptyFn});
MapTo('vation-headless/components/teaser')(TeaserV1, {isEmpty: TeaserV1IsEmptyFn});
MapTo('vation-headless/components/image')(ImageV2, {isEmpty: ImageV2IsEmptyFn});
MapTo('vation-headless/components/title')(TitleV2, {isEmpty: TitleV2IsEmptyFn});


MapTo('vation-headless/components/breadcrumb')(BreadCrumbV2, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('vation-headless/components/navigation')(NavigationV1);
MapTo('vation-headless/components/languagenavigation')(LanguageNavigationV1);


MapTo('vation-headless/components/tabs')(TabsV1, {isEmpty: TabsV1IsEmptyFn});
MapTo('vation-headless/components/accordion')(AccordionV1, {isEmpty: AccordionV1IsEmptyFn});
MapTo('vation-headless/components/carousel')(CarouselV1, {isEmpty: CarouselV1IsEmptyFn});
MapTo('vation-headless/components/container')(ContainerV1, {isEmpty: ContainerV1IsEmptyFn});
